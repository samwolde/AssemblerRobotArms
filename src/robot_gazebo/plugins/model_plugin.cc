...
namespace gazebo{
    ...
    public: 
        ...
        void Load(physics::ModelPtr parent , sdf::ElementPtr sdf_ptr){
            ...
            this->front_left_wheel  = this->model->GetJoint("susp_wheel_4");
            this->front_right_wheel  = this->model->GetJoint("susp_wheel_1");
            this->back_right_wheel = this->model->GetJoint("susp_wheel_2");
            this->back_left_wheel = this->model->GetJoint("susp_wheel_3");
        ...
        void MoveForward(double vel){
            ...
            std::string name_fr = this->model->GetJoint("susp_wheel_1")->GetScopedName();
            std::string name_fl = this->model->GetJoint("susp_wheel_4")->GetScopedName();
            std::string name_br = this->model->GetJoint("susp_wheel_2")->GetScopedName();
            std::string name_bl = this->model->GetJoint("susp_wheel_3")->GetScopedName();
